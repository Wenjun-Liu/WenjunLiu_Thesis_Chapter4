...
```{r plotSummary, fig.height= 15, fig.cap = "*Comparison of FastQC summaries A) before and B), after trimming*"}
...
```{r plotSeqContentResid, fig.width = 18, fig.cap = "*Base and Position specific residuals for each sample. The mean base content at each position was calculated for each nucleotide, and the sample-specific residuals calculated.*"}
plotly::ggplotly(
